   ...
   /**
	...
	switch (row)
	  ...
	  case 1:
		...
		break;
	      default:
		throw new ArrayIndexOutOfBoundsException(("Matrix4d0"));
	      }
	    break;
	...
	throw new ArrayIndexOutOfBoundsException(("Matrix4d1"));
    }
    ...
    public final void getRow(int row, Vector4d v) {
        if( row == 0 ) {
          ...
          throw new ArrayIndexOutOfBoundsException(("Matrix4d2"));
        }
    }
...
//    }
   ...
   */
   ...
   /**
	...
	default:
            throw new ArrayIndexOutOfBoundsException(("Matrix4d4"));
	...
	default:
            throw new ArrayIndexOutOfBoundsException(("Matrix4d7"));
	}
    }
  ...
  public final void invert()
  {
...

	{
		...
		if (imax < 0) {
		    throw new RuntimeException(("Matrix4d11"));
		}
